...
@section('content')
    ...
    @section('title','Devolução De Produtos ' . ucwords(strtolower($filial)))

    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="mb-0">{{ ucwords(strtolower($filial)) }}</h3>
                <h3 class="tile-title">Produtos Para Devolução</h3>
                <div class="tile-body">
                    <table id="table" class="display compact">
                        ...
                        @forelse($produtos as $produto)
                            <tr>
                                ...
                                <td>{{ number_format($produto->qt,3) }} Kg</td>
